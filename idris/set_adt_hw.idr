...
--help_remover v nil = nil
--help_remover v (h::t)= ite (member v (h::t))
-- helper function: return list l without value v

list_remove: (eq a) => (v: a) -> (l: list a) -> list a
list_remove v nil = nil
list_remove v (h::t) = ite (member v (h::t)) (list_remove v t) (h::t)
...
set_member v (mkSet l) = ite (member v l) true false
...
set_union (mkSet (h::t)) (mkSet l2) = set_insert h (mkSet l2)
...
list_difference (h::t) lb = ite (member h lb) (list_difference t lb) (h::(list_difference t lb))

-- Return the set difference, s1 minus s2 (or s1 intersection s2 complement)
--set_difference: (eq a) => (s1: set a) -> (s2: set a) -> set a
set_difference (mkSet l1) (mkSet l2) = set_intersection (mkSet l1) (mkSet (list_difference l1 l2))

-------------------------------------
-- hint: write one line of code using higher-order functions
list_forall: (p: a -> bool) -> (s: list a) -> bool
list_forall p nil = true
list_forall p (h::t) = ite (member false (map p (h::t))) false (list_forall p t)
...
-- hint: write one line of code using higher-order functions
list_exist: (p: a -> bool) -> (s: list a) -> bool
list_exist p (h::t) = ite (member true (map p (h::t))) true false
-- Return true if p is true for some v in s, otherwise else false
-- set_exists: (p: a -> bool) -> (s: set a) -> bool
set_exists p (mkSet l) = list_exist p l
...
set_witness p (mkSet (h::t)) = ite (set_exists p (mkSet (h::t))) (some h) (none)
-------------------------------------
...
-- pair elt takes an elt h and a list b and returns a list of all pairs, (h, e),
